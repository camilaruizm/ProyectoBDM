...
namespace ProyectoBDM.Control
{
    class ControlEstadoCuenta
    {
        ...
        public void showPeliculaCli(MySqlDataAdapter adaptador, DataGridView dgvP, int idUsuario)
        {
            conexion.Open();
        ...
        public void showMultaCli(MySqlDataAdapter adaptador, DataGridView dgvM, int idUsuario)
        {
            conexion.Open();
